...
class PluginManifestTest(unittest.TestCase):
    def test_required_101_app_matches_the_registered_dependency(self):
        ...
        self.assertEqual(
            ...
            {
                'apps': {
                    'dev-6a873bd922fc81918cb1146746b83625': {
                        'id': 'asdk_app_6a873bd922fc81918cb1146746b83625',
                        'required': True,
                    },
                },
            },
    ...
    def test_patch_release_is_declared_consistently(self):
        ...
        self.assertIn('Текущая версия плагина для Codex: `2.0.1`.', readme)
