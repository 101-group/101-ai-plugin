...
Finish with `готово`, `частично`, or `заблокировано`; list created, not created, and not started reports by human name, show fresh data, and give the smallest next step.
