...
Для перевода любого типа доля по проекту всегда 100 %. Перевод всегда выполняется только по одному проекту. Логика одного перевода на несколько объектов в приложении пока не реализована.
